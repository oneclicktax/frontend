      ...
      {expanded && (
        <div className="mt-4 flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <span className="text-sm text-black-60">주민등록번호</span>
            <span className="text-sm font-medium text-black-100">
              {formatResidentNumber(earner.residentNumber)}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-black-60">전화번호</span>
            <span className="text-sm font-medium text-black-100">
              {formatPhone(earner.phone)}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-black-60">지급 날짜</span>
            <span className="text-sm font-medium text-black-100">
              {earner.paymentDate}
            </span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-black-60">소득 지급 유형</span>
            <span className="text-sm font-medium text-black-100">
              {earner.incomeType}
            </span>
          </div>
